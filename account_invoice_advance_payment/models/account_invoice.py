...
class AccountInvoice(models.Model):
    ...
    invoice_pos_line = fields.One2many('account.invoice.line', 'invoice_id', string='Positive Invoice Lines',
        readonly=True, compute='_compute_lines')
    ...
    def _compute_amount(self):
        ...
        self.amount_tax = self.amount_pos_tax + self.amount_neg_tax
        self.amount_total = self.amount_pos_total +  self.amount_neg_total
